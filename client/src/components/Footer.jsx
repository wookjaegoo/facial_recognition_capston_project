...
function Footer() {
  ...
  async function discriptorFromImage(e) {
    try {
      ...
      const issueRedNotice = await contract.methods
        .issueRedNotice(requstid)
        .send({ from: accounts[0] });
          ...
          <div className="container">
            <div className="CrimeDetail" style={{ display: "inline-block" }}>
              ...
              >
                <div style={{ width: "210px", height: "30px" }}>
                  ...
                  <input
                    ...
                    onChange={onChange}
                    value={cname}
                    style={{ width: "150px", height: "30px", float: "right" }}
                  />
                </div>
              ...
              >
                <input
                  name="selectaddr"
                  placeholder="insert address for athorization"
                  value={selectaddr}
                  onChange={onChange}
                ...
                <label onClick={getCriminal} className="custom-btn2">
                  criminal log
                </label>
                <label
                  type="fileupload"
                  onClick={discriptorFromImage}
                  id="fileup"
                  className="custom-btn2"
                >
                  transaction
