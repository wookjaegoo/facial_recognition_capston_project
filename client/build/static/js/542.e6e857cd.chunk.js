  ...
  [542],
  {
          ...
          function t(e) {
            ...
            e.eventListener
              ...
              (this._reloadOnDisconnect =
                null === (o = e.reloadOnDisconnect) || void 0 === o || o);
            var p = new URL(h),
              b = "".concat(p.protocol, "//").concat(p.host);
            (this._storage = new s.ScopedLocalStorage(
              ...
              this.walletExtension ||
                ...
                ((this._relayEventManager = new l.WalletSDKRelayEventManager()),
          ...
          return (
            i(t, [
              ...
              },
              {
                ...
                get: function () {
                  var t;
                  return null !== (t = window.coinbaseWalletExtension) &&
                    void 0 !== t
                    ? t
    ...
    33771: function (t, e, n) {
      ...
      e.SnackbarInstance = function (t) {
        var e = t.autoExpand,
          ...
          f = l[0],
          d = l[1],
          p = (0, a.useState)(null !== e && void 0 !== e && e),
          b = r(p, 2),
          v = b[0],
          y = b[1];
      ...
      var s = n(95471),
        ...
        v = (function () {
          function t(e, n, r, o) {
            ...
            var b = new f.RxWebSocket(r + "/rpc", d);
            (this.ws = b),
              this.subscriptions.add(
                b.connectionState$
                  .pipe(
                    (0, u.tap)(function (t) {
                      var n;
                      return null === (n = l.diagnostic) || void 0 === n
                        ? void 0
      ...
      var d = f(n(2727)),
        ...
        C = (function (t) {
          ...
          function n(t) {
            var r, i, o;
            u(this, n),
              ((r = e.call(this))._filterPolyfill = new _.FilterPolyfill(a(r))),
              ...
              (r.isCoinbaseWallet =
                null === (i = t.overrideIsCoinbaseWallet) || void 0 === i || i),
              (r.isCoinbaseBrowser =
                null !== (o = t.overrideIsCoinbaseBrowser) &&
                void 0 !== o &&
                o),
              (r.qrUrl = t.qrUrl),
            ...
            var s = r.getChainId(),
              c = (0, m.prepend0x)(s.toString(16));
            r.emit("connect", { chainIdStr: c });
            var l = r._storage.getItem(g.LOCAL_STORAGE_ADDRESSES_KEY);
            if (l) {
              var h = l.split(" ");
              "" !== h[0] &&
          ...
          return (
            c(n, [
              ...
              },
              {
                ...
                get: function () {
                  var t;
                  return null !== (t = this._storage.getItem(E)) && void 0 !== t
                    ? t
                                  ...
                                  (null === (e = this.diagnostic) ||
                                    ...
                                    e.log(v.EVENTS.ETH_ACCOUNTS_STATE, {
                                      ...
                                      sessionIdHash: this._relay
                                        ? y.Session.hash(this._relay.session.id)
                                        : void 0,
                                    }),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    ...
                    {
                      fromAddress: e,
                      toAddress: t.to ? (0, m.ensureAddressString)(t.to) : null,
                      weiValue:
                        null != t.value
                      ...
                      nonce:
                        null != t.nonce
                          ...
                          : null,
                      gasPriceInWei:
                        null != t.gasPrice ? (0, m.ensureBN)(t.gasPrice) : null,
                      maxFeePerGas:
                        null != t.maxFeePerGas
                      ...
                      maxPriorityFeePerGas:
                        null != t.maxPriorityFeePerGas
                          ...
                          : null,
                      gasLimit: null != t.gas ? (0, m.ensureBN)(t.gas) : null,
          ...
          return (
            u(t, [
              ...
              },
              {
                key: "uninstallFilter",
                value: function (t) {
                  var e = (0, a.intNumberFromHexString)(t);
                  return (
          ...
          function n(t) {
            ...
            return (
              ...
              (r._reloadOnDisconnect =
                null === (o = t.reloadOnDisconnect) || void 0 === o || o),
              (r.ui = c),
              r
            );
          }
                    ...
                    this.subscriptions.add(
                      i.sessionConfig$
                        .pipe(
                          (0, v.filter)(function (t) {
                            return (
                              !!t.metadata && "1" === t.metadata.__destroyed
                            );
                          }),
                        )
                        .subscribe(function () {
                    ...
                    this.subscriptions.add(
                      i.sessionConfig$
                        .pipe(
                          (0, v.filter)(function (t) {
                            return (
                              t.metadata && void 0 !== t.metadata.WalletUsername
                            );
                          }),
                        )
                        .pipe(
                  ...
                  this.connection
                    ...
                    .subscribe(
                      function (e) {
                        ...
                        var s = x.Session.load(t.storage);
                        if (
                    ...
                    promise: new Promise(function (o, s) {
                      ...
                      if (
                        ...
                        if (t.ui.inlineAccountsResponse()) {
                          ...
                          var l = p.ethErrors.provider.userRejectedRequest(
                            "User denied account authorization",
                          );
                          t.ui.requestEthereumAccounts({
                            onCancel: function () {
                      ...
                      })),
                    {
                      ...
                      promise: new Promise(function (l, h) {
                        s.relayEventManager.callbacks.set(a, function (t) {
                          if (
                            (null === c || void 0 === c || c(), t.errorMessage)
                          )
    ...
    39830: function (t, e, n) {
      ...
      (e.randomBytesHex = function (t) {
        ...
        (e.ensureAddressString = function (t) {
          if ("string" === typeof t) {
            var e = p(t).toLowerCase();
            if (v(e) && 40 === e.length) return (0, a.AddressString)(b(e));
          }
        ...
        (e.ensureBN = function (t) {
          if (null !== t && (u.default.isBN(t) || w(t)))
            return new u.default(t.toString(10), 10);
          if ("number" === typeof t) return new u.default(m(t));
          if ("string" === typeof t) {
    ...
    20402: function (t, e, n) {
      ...
      function h(t, e) {
        ...
        if (
          ...
          if ("dynamic" !== (n = a(t)) && 0 !== n && e.length > n)
      ...
      var r = n(41999).Buffer,
        ...
        a = {
          ...
          findTypeDependencies: function (t, e) {
            ...
            try {
              for (o.s(); !(r = o.n()).done; ) {
                var s,
                  u = r.value,
                  c = i(this.findTypeDependencies(u.type, e, n));
                try {
                  for (c.s(); !(s = c.n()).done; ) {
                    var a = s.value;
          ...
          sanitizeData: function (t) {
            var e = {};
            for (var n in c.properties) t[n] && (e[n] = t[n]);
            return (
              e.types &&
    ...
    98319: function (t) {
        ...
        (n.createBytes = function (t, e) {
          for (
            ...
            var h = d.getErrorCorrectPolynomial(a),
              f = new v(o[u], h.getLength() - 1).mod(h);
      ...
      function w(t) {
        ...
        (this.qrcode = new n(o, s)), this.qrcode.addData(r), this.qrcode.make();
      }
          ...
          if (
            ...
            (p.code = b.code),
              b.message && "string" === typeof b.message
                ...
                : ((p.message = c(p.code)), (p.data = { originalError: h(t) }));
          } else {
            p.code = s.code;
            var v = null === (e = t) || void 0 === e ? void 0 : e.message;
            (p.message = v && "string" === typeof v ? v : s.message),
    ...
    32347: function (t, e, n) {
        ...
        for (n.__k = [], l = 0; l < e.length; l++)
          if (
            ...
            if (
              ((b.__ = n),
              (b.__b = n.__b + 1),
              null === (p = _[l]) || (p && b.key == p.key && b.type === p.type))
            )
              _[l] = void 0;
            else
              for (h = 0; h < k; h++) {
      ...
      function W(t, e, n, i, o, s, u, c) {
        ...
        if (null === b) d === p || (c && t.data === p) || (t.data = p);
        else {
          if (
      ...
      (u.options.__b = function (t) {
        ...
        (u.options.diffed = function (t) {
          ...
          e &&
            e.__H &&
            (e.__H.__h.length &&
              ((1 !== a.push(e) && s === u.options.requestAnimationFrame) ||
      ...
      t.exports = function t(e, n, r, i) {
        ...
        if (H(e)) {
          var tt = T
            ...
            : N.call(e);
          return "object" !== typeof e || T ? tt : G(tt);
        }
        if (
          (function (t) {
            ...
            ht =
              !at && A && Object(e) === e && A in e
                ...
                : lt
                  ...
                  : "",
            ft =
              (at || "function" !== typeof e.constructor
                ? ""
                : e.constructor.name
                  ? e.constructor.name + " "
                  : "") +
      ...
      var r = n(76296),
        ...
        a = function (t, e, n, r) {
          if (t) {
            ...
            for (
              var h = 0;
              n.depth > 0 && null !== (u = s.exec(o)) && h < n.depth;
                      ...
                      if (n !== d) {
                        ...
                        -1 === m
                          ...
                          : ((b = e.decoder(
                            ...
                            (v = r.maybeMap(c(y.slice(m + 1), e), function (t) {
    ...
    83717: function (t, e, n) {
      ...
      var r = n(76738),
        ...
        b = {},
        v = function t(e, n, o, s, u, l, f, d, v, y, g, m, w, _, k, x) {
          for (
          ...
          if (
            ...
            if (f) {
              var T = _ ? n : f(n, p.encoder, k, "key", m);
              if ("comma" === o && _) {
                for (
                  ...
                  L +=
                    (0 === j ? "" : ",") + w(f(A[j], p.encoder, k, "value", m));
                return [
                  w(T) + (s && c(E) && 1 === A.length ? "[]" : "") + "=" + L,
                ];
              }
          ...
          for (
            var P = s && c(E) && 1 === E.length ? n + "[]" : n, W = 0;
            W < O.length;
            ++W
          ) {
            var F = O[W],
    ...
    95471: function (t, e, n) {
        ...
        return function () {
          ...
          return new r.y(function (r) {
            var i = o.context,
              s = o.subject;
            if (n)
              return n.schedule(z, 0, { params: o, subscriber: r, context: i });
            if (!s) {
              s = o.subject = new l.c();
              try {
                t.apply(
      ...
      function bt() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        if (0 === t.length) return K.E;
        var n = t[0],
          i = t.slice(1);
        return 1 === t.length && (0, W.k)(n)
          ? bt.apply(void 0, n)
          : new r.y(function (t) {
              var e = function () {
    ...
    70195: function (t, e, n) {
      ...
      function u() {
        ...
        return (
          ...
          null === u && 1 === t.length && t[0] instanceof r.y
            ? t[0]
            : (0, o.J)(n)((0, s.n)(t, u))
        );
      }
    ...
    89513: function (t, e, n) {
      ...
      function a() {
        ...
        var n = t[t.length - 1];
        return (
          "function" === typeof n && t.pop(), (0, i.n)(t, void 0).lift(new l(n))
        );
      }
      var l = (function () {
          function t(t) {
    ...
    84539: function (t, e, n) {
      ...
      function U() {
        ...
        return (
          "function" === typeof t[t.length - 1] && (n = t.pop()),
          1 === t.length && (0, B.k)(t[0]) && (t = t[0].slice()),
          function (e) {
      ...
      function Ft(t) {
        return function (e) {
          return 0 === t ? (0, Wt.c)() : e.lift(new Vt(t));
        };
      }
      var Vt = (function () {
          function t(t) {
      ...
      function we(t) {
        return function (e) {
          return 0 === t ? (0, Wt.c)() : e.lift(new _e(t));
        };
      }
      var _e = (function () {
          function t(t) {
        ...
        or = (function (t) {
          function e(e, n, r) {
            ...
            return (
              ...
              (r && "function" === typeof r.schedule) || (i.scheduler = rr.e),
              i
            );
          }
          return (
